...
{ 
    ...
    case 4://ah
        ax = (ax & 0x00FF) | ((dataGiven & 0x00ff) << 8); //either 0xff00 if i keep in lower byte on high part, or the same
        break;
    ...
    case 6://dh
        dx = (dx & 0x00FF) | ((dataGiven & 0x00ff) << 8);
        break;

    case 7://bh
        bx = (bx & 0x00FF) | ((dataGiven & 0x00ff) << 8);
        break;
